...
export class Controller {
    ...
    static init(){
        ...
        wind.add(this.goalAttributes, 'windSpeed').min(0).max(20).step(0.1).name('Wind Speed');
        ...
        boat.add(this.goalAttributes, 'rudderAngle').min(-30).max(30).step(0.5).name('Rudder Angle');
